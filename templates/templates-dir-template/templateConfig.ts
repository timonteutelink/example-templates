...
const templateSettingsSchema = z.object({
  ...
  template_dir_name: z
    ...
    .optional()
    .default("templates")
    .describe("The name of the template repository directory"),
  template_author_name: z
    .string()
    .optional()
    .default("Timon Teutelink")
    .describe("The author name to put in the package.json files"),
  template_author_email: z
    .string()
    .optional()
    .default("timon@teutelink.nl")
    .describe("The author email to put in the package.json files"),
  template_license: z
    .string()
    .optional()
    .default("MIT")
    .describe("The license to put in the package.json files"),
  template_description: z
    .string()
    .optional()
    .default("Cool repository full of templates.")
    .describe("The description to put in the root package.json file"),
});
